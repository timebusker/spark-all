...
/**
 * @DESC:SougouLogGenerateTask
 * @author:timebusker
 * @date:2019/8/30
 */
//@Component
public class SougouLogGenerateTask extends AbstractBaseTask {
    ...
    public void init() throws Exception {
        ...
        vo.setZkWorkPath(config.getSougouZK());
        vo.setEncode(FileUtil.ENCODE_GBK);
        // 创建工作目录
        zookeeperUtil.createWorkNode(vo);
        // 设置文件后缀
        super.suffix = "txt";
        vo.setSourcePath(config.getSougou());
    }
    ...
    public void execute() throws Exception {
        ...
        FileUtil.writeFile(new File(PATH + config.getSougouZK().toLowerCase() + FILE_NAME + order), data);
